...
@XmlRootElement
@NamedQueries({
        @NamedQuery(name = "IncidentHistory.findAll", query = "SELECT i FROM IncidentHistoryCognitecEntity i")
})
public class IncidentHistoryCognitecEntity implements Serializable {
    ...
    public IncidentHistoryCognitecEntity() {
    }
